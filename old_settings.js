...
function nextPlayer() {
    ...
    if (iconChoice != "" && $("#nameInput").val() != "") {
        ...
        if (players.length >= playerCount) {
            ...
            window.location.href = "old_scoreboard.html?players=" + encodeURI(players) + "&rounds=" + rounds + "&controllers=" + controllers + "&betterRandom=" + betterRandom + "&seed=" + Math.floor(Math.random() * 100000) + "&mapNumber=" + 0;
